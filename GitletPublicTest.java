...
public class GitletPublicTest {
    ...
    private static final String OTHER_TEST_DIR = "test_files2/";
    ...
    @Test
    public void testAdd() {
        String random = TESTING_DIR + "dog.txt";
        String rantext = "puppy";
        createFile(random, rantext);
        gitlet("init");
        gitlet("add", random);
        gitlet("commit", "first");
        writeFile(random, "pie");
        gitlet("add", random);
        gitlet("commit", "first");
        assertEquals("pie", getText(random));
    }

    @Test
    public void testCheckout() {
        String random = TESTING_DIR + "dog.txt";
        String random2 = OTHER_TEST_DIR + "dog.txt";
        String rantext = "puppy";
        String ran2text = "bigdog";
        createFile(random, rantext);
        createFile(random2, ran2text);
        gitlet("init");
        gitlet("add", random);
        gitlet("add", random2);
        gitlet("commit", "first");
        writeFile(random, "pie");
        gitlet("checkout", random);
        assertEquals(rantext, getText(random));
    }
    ...
    //     System.out.println(gitlet("test"));
